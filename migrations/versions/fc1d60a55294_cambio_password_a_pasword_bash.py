"""cambio password a pasword_bash

Revision ID: fc1d60a55294
Revises: 
Create Date: 2024-09-17 20:59:11.374572
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('nombre', sa.String(length=30), nullable=False),
    sa.Column('cuit', sa.String(length=30), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('user',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('username', sa.String(length=50), nullable=False),
    sa.Column('password_bash', sa.String(length=300), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
